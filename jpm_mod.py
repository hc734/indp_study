...
model = None
try:
    model = pickle.load(open("lstm_model", 'rb'))   #### you can change the model name if you ended up
...
#### SET as TRUE if you want to run the model again,
# model file hsould be named 'lstm_model' in the working directory
